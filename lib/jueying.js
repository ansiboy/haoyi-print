...
(function (jueying) {
    ...
    class ControlFactory {
        ...
        static exportElement(element) {
            ...
            let result = { type: name, props: { id }, children: [] };
            result.props = data;
            if (childElements) {
...
(function (jueying) {
    ...
    class PageDesigner extends React.Component {
        ...
        set pageData(value) {
            if (!value)
                throw jueying.Errors.argumentNull('value');
        ...
        render() {
            let designer = this;
            return h("div", { className: "designer", tabIndex: 1, ref: e => this.element = e || this.element, onKeyDown: (e) => this.onKeyDown(e) },
...
(function (jueying) {
    class EditorPanel extends React.Component {
        ...
        componentDidMount() {
            if (!this.designer)
                return;
            let onChanged = (control) => __awaiter(this, void 0, void 0, function* () {
                if (control == null) {
        ...
        render() {
            ...
            return h(jueying.DesignerContext.Consumer, null, context => {
                ...
                return h("div", Object.assign({}, jueying.Control.htmlDOMProps(this.props), { className: "editor-panel panel panel-primary", ref: (e) => this.element = e || this.element }),
                    h("div", { className: "panel-heading" }, "\u5C5E\u6027"),
    ...
    (function (extentions) {
        class DesignerFramework extends React.Component {
            ...
            createButtons(pageDocument, buttonClassName) {
                ...
                return [
                    h("button", { className: buttonClassName, disabled: !isChanged, onClick: () => this.save() },
                        h("i", { className: "icon-save" }),
                        h("span", null, "\u4FDD\u5B58")),
                    h("button", { className: buttonClassName, onClick: () => this.redo() },
                        h("i", { className: "icon-repeat" }),
                        h("span", null, "\u91CD\u505A")),
                    h("button", { className: buttonClassName, onClick: () => this.undo() },
                        h("i", { className: "icon-undo" }),
                        h("span", null, "\u64A4\u9500")),
                    h("button", { className: buttonClassName },
                        h("i", { className: "icon-eye-open" }),
                        h("span", null, "\u9884\u89C8")),
                    h("button", { className: buttonClassName, onClick: () => this.newFile() },
                        h("i", { className: "icon-file" }),
                        h("span", null, "\u65B0\u5EFA")),
                    h("button", { className: buttonClassName, onClick: () => this.open() },
                ...
                return h(jueying.PageDesigner, { pageData: pageDocument ? pageDocument.pageData : null, ref: (e) => this.pageDesigner = e || this.pageDesigner },
                    h(jueying.DesignerContext.Consumer, null, c => {
                        ...
                        return h(React.Fragment, null,
                            h("ul", { className: "toolbar clearfix" },
                                h("li", { className: "pull-left" },
                                    h("h3", null, title || '')),
                                buttons.map((o, i) => h("li", { key: i, className: "pull-right" }, o))),
                            h("hr", { style: { margin: 0, borderWidth: 4 } }),
                            h(jueying.ComponentToolbar, { className: "component-panel", componets: components }),
                            ...
                            h("div", { className: "main-panel", onClick: (e) => {
                                ...
                                h(React.Fragment, null,
                                    h("ul", { className: "nav nav-tabs" }, pageDocuments.map((o, i) => h("li", { key: i, role: "presentation", className: i == activeDocumentIndex ? 'active' : null, onClick: () => this.activeDocument(i) },
                                        h("a", { href: "javascript:" },
                                            o.name,
                                ...
                                h("div", { className: extentions.classNames.emptyDocument }, "\u6682\u65E0\u6253\u5F00\u7684\u6587\u6863")));
                    }));
            }
        }
                    ...
                    h("div", { className: "modal-content", style: { width: dialog_content_width } },
                        ...
                        h("div", { className: "modal-footer" },
                            ...
                            h("div", { className: "pull-right" },
                                h("button", { className: "btn btn-primary", onClick: () => this.confirm() },
                                    h("i", { className: "icon-ok" }),
                                    h("span", null, "\u786E\u5B9A"))))));
            }
